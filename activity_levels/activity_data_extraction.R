...
bat_passes_data <- data.frame(paper_ID = rep(NA, 15), species = rep(NA,15), light_treatment_mean = rep(NA, 15), dark_treatment_mean = rep(NA, 15), light_se = rep(NA,15), dark_se = rep(NA, 15))
# Lou et al. (2012)
